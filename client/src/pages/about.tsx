    ...
    <div className="min-h-screen bg-gray-50 pt-16 pb-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">About GIS_BS</h1>
        ...
        <Card className="mb-12 border-none shadow-lg">
          ...
          <CardContent className="pt-6 pb-8 px-6">
            <p className="text-gray-700 leading-relaxed mb-6">
              GIS_BS (Geographic Information System for Benton Spatial analysis) was developed to 
        ...
        <div className="text-center text-gray-500 text-sm mt-16">
          ...
          <p className="mt-1">GIS_BS is an advanced geospatial platform for property valuation.</p>
        </div>
      </div>
    </div>
  );
